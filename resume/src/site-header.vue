  ...
  >
    ...
    <v-tooltip v-for="link in links" :key="`${link.icon}`" bottom>
      <template v-slot:activator="{ on }">
        <v-btn icon @click="navigate(link.href)" v-on="on">
...
export default {
  ...
  data: () => ({
    photos: [
      {
        src: masthead1,
        kudos: 'Masthead Photo by Henry Be on Unsplash',
        link: 'https://unsplash.com/@henry_be?utm_medium=referral&amp;utm_campaign=photographer-credit&amp;utm_content=creditBadge',
      },
      {
        src: masthead2,
        kudos: 'Masthead Photo by Jonas Jacobsson on Unsplash',
        link: 'https://unsplash.com/@jonasjacobsson?utm_medium=referral&amp;utm_campaign=photographer-credit&amp;utm_content=creditBadge',
      },
      {
        src: masthead3,
        kudos: 'Masthead Photo by 🇸🇮 Janko Ferlič on Unsplash',
        link: 'https://unsplash.com/@itfeelslikefilm?utm_medium=referral&amp;utm_campaign=photographer-credit&amp;utm_content=creditBadge',
      },
      {
        src: masthead4,
        kudos: 'Masthead Photo by Aaron Burden on Unsplash',
        link: 'https://unsplash.com/@aaronburden?utm_medium=referral&amp;utm_campaign=photographer-credit&amp;utm_content=creditBadge',
      },
      {
        src: masthead5,
        kudos: 'Masthead Photo by Pono Lopez on Unsplash',
        link: 'https://unsplash.com/@ponolopez?utm_medium=referral&amp;utm_campaign=photographer-credit&amp;utm_content=creditBadge',
      },
    ],
    links: [
      {
